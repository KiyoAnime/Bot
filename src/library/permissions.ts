export default {
    ...
    useExternalEmojis: Number(1 << 18),
    viewGuildInsights: Number(1 << 19),
    connect: Number(1 << 20),
    speak: Number(1 << 21),
    ...
    manageEmojisAndStickers: Number(1 << 30),
    useApplicationCommands: Number(1 << 31),
    requestToSpeak: Number(1 << 32),
    manageEvents: Number(1 << 33),
    manageThreads: Number(1 << 34),
    createPublicThreads: Number(1 << 35),
    createPrivateThreads: Number(1 << 36),
    useExternalStickers: Number(1 << 37),
    sendMessagesInThreads: Number(1 << 38),
    useEmbeddedActivities: Number(1 << 39),
